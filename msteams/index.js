...
let authUrl = function() {
    return wlo +'/v1/auth/authorize?clientId=' + auClientId + '&serviceType=Office365&authServiceType=MsTeamsBot&userAccount=primary&returnUrl=' + encodeURIComponent(wlo + '/msteams/auth_callback.html')
}
